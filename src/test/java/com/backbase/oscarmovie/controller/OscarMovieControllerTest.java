...
public class OscarMovieControllerTest {
    ...
    public void validURL_shouldReturnWith401() {
        ...
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscar/allMovies"), HttpMethod.GET, entity, String.class);
        assertEquals(401, response.getStatusCode().value());
    }

    @Test
    public void validURL_shouldReturnWith200() throws JsonProcessingException {
    ...
    @Test
    public void invalidURL_shouldFailWith404() {
    	headers.setBearerAuth(generateAccessToken());
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscars/allMovie"),HttpMethod.GET, entity, String.class);
        assertEquals(404, response.getStatusCode().value());
    }

    @Test
    public void getMovieWinOscar_shouldReturnWith200() {
    	headers.setBearerAuth(generateAccessToken());
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscar/winOscar/Chicago"), HttpMethod.GET, entity, String.class);
        assertEquals(200, response.getStatusCode().value());
    }
    
    @Test
    public void getMovieWinOscarInvalidURL_shouldReturnWith404() {
    	headers.setBearerAuth(generateAccessToken());
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscar/winOscar"), HttpMethod.GET, entity, String.class);
        assertEquals(404, response.getStatusCode().value());
    }
    
    @Test
    public void getAllMovieNotWinOscar_shouldReturnWith200() {
    	headers.setBearerAuth(generateAccessToken());
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscar/allMovieNotWinOscar"), HttpMethod.GET, entity, String.class);
        assertEquals(200, response.getStatusCode().value());
    }
    
    @Test
    public void getAllMovieWinOscar_shouldReturnWith200() {
    	headers.setBearerAuth(generateAccessToken());
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<?> response = restTemplate.exchange(createURLWithPort("/oscar/allMovieWinOscar"), HttpMethod.GET, entity, String.class);
        assertEquals(200, response.getStatusCode().value());
    }
